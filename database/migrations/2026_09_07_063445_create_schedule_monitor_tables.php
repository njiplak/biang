...
class CreateScheduleMonitorTables extends Migration
{
    ...
    // Added by us: the published package migration ships without a down(),
    // so a rollback silently removed the migration row while leaving the
    // tables behind, breaking the next migrate.
